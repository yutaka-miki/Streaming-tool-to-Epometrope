...
void ofApp::draw(){ 
    ...
    ofSetColor(1000);
    // ofSetHexColor(int hexColor)
    // fbo1.draw(pos*Width/W, 0, Width/W, Height/H);

    // fbo1.draw(0, Height-pos*Height/H-Height*0.25, Width/W , Height/H);
    // fbo1.draw(0, (H-1-pos)*Height/H, Width/W , Height/H);
    // fbo1.draw(Width/W, (H-1-pos)*Height/H, Width/W , Height/H);
    // fbo1.draw(2*Width/W, (H-1-pos)*Height/H, Width/W , Height/H);
    // fbo1.draw(3*Width/W, (H-1-pos)*Height/H, Width/W , Height/H);
